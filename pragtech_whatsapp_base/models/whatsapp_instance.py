...
class WhatsappInstance(models.Model):
    ...
    provider = fields.Selection([('whatsapp_chat_api', 'Whatsapp Chat Api'), ('gupshup', 'Gupshup'), ('whatsapp_meta_api', 'Whatsapp Meta Api')], string="Whatsapp Service Provider",
    ...
    def get_whatsapp_instance(self):
        ...
        provider_list = ['gupshup', 'whatsapp_chat_api', 'whatsapp_meta_api']

                    ...
                    for record in self.env[active_model].browse(active_ids):
                        ...
                        if active_model != 'res.partner':
                            if active_model == 'crm.lead':
                                ...
                                partner = record or record.partner_id
                            elif active_model == 'sale.order':
                                link = record.get_portal_url()
                                origin = record.name
                        ...
                        #if partner.whatsapp:
                        #print ('===record===',record)
                        whatsapp = partner._formatting_mobile_number() or record.whatsapp
                        if whatsapp and whatsapp not in opt_out_list:                          
